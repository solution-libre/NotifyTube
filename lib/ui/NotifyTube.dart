...
import 'package:NotifyTube/ui/NotifyTube.dart';
...
class NotifyTubeState extends State<NotifyTube> {
  ...
  Future<Null> fetchYoutubeApiData() async {
    ...
    if (_currentUser != null) {
      ...
      await SubscriptionDataBase.updateSubscriptionsFromYt(subscriptionListFromAPI).then((future) async => await initSubscriptionsWidgetList());
  ...
  Future initSubscriptionsWidgetList() async {
    setState(() {
